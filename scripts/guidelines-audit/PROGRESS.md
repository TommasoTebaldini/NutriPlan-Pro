...
| 274 | epatite_c_cronica | 🔧 corretto-con-fix (approfondito) | 2026-08-03 | Follow-up dedicato: confermati due documenti EASL reali e distinti — "EASL recommendations on treatment of hepatitis C: Final update" (J Hepatol 2020;73(5):1170-1218, PMID 32956768, copre DAA/SVR) + "EASL position paper on clinical follow-up after HCV cure" (J Hepatol, ago 2024, PMID 38845253, copre esattamente il monitoraggio MASLD/HCC post-SVR già nella scheda). Corretto badge/note/science/fonte in "EASL 2020 + EASL 2024" con PMID espliciti, in entrambi i file. |
| 275 | intolleranza_sorbitolo | 🔧 corretto-con-fix (approfondito) | 2026-08-03 | Follow-up dedicato: confermato che "SGAMN" (e l'espansione "Società Gastroenterologi Associati Medici Nutrizione") non esiste come ente reale — nessun riscontro trovato. Rimossa l'attribuzione inventata in badge/note/science/fonte, mantenuto solo "Monash FODMAP Protocol" (già presente e reale, con Halmos 2014 Gastroenterology come studio fondativo), in entrambi i file. |
...
| 283 | ansia_nutrizione | 🔧 corretto-con-fix (approfondito) | 2026-08-03 | Follow-up dedicato: confermato che ISSFAL esiste ma pubblica solo raccomandazioni generali di intake omega-3, nessuna dichiarazione specifica su ansia. La vera fonte sostanziale è Su KP et al. 2018 (JAMA Netw Open 1(5):e182327, meta-analisi 19 RCT, SMD -0.37), già citata nel campo science. Stesso pattern di "sonno_nutrizione": corretto badge/note/fonte in "Revisione narrativa (Su 2018, JAMA Netw Open)" in entrambi i file. |
...
| 285 | burnout_nutrizionale | 🔧 corretto-con-fix (approfondito) | 2026-08-03 | Follow-up dedicato: stesso problema di riga 283, nessuna "ISSFAL 2021" su stress/burnout esiste. Fonti sostanziali reali già citate (Chandrasekhar 2012, Indian J Psychol Med, ashwagandha -27.9% cortisolo; Tomiyama 2010, Psychosom Med; Daubenmier 2012). Corretto badge/note/fonte in "Revisione narrativa (Chandrasekhar 2012 e altri)" in entrambi i file. |
